...
Yêu cầu thêm để đồng bộ với màn lên kế hoạch của ứng dụng:
- Trường "calories" phải là lượng calo ước tính rõ ràng cho 1 khẩu phần.
- Tên món và lượng calo phải đủ tự nhiên để hệ thống có thể suy ra huy hiệu khi người dùng ăn món đó.
- Hãy ưu tiên đặt tên món sao cho người dùng nhìn vào là hiểu ngay món này sẽ kích hoạt nhóm huy hiệu nào: Ăn chay, Tinh bột tốt, Giảm mỡ, hoặc Tăng cơ.
